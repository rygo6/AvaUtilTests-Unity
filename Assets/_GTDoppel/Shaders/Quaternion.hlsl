...
float3 rotate_point(float4 rotation, float3 p)
{
    float num1 = rotation.x * 2.0;
    ...
    float3 vector3;
    vector3.x = ((1.0 - ( num5 +  num6)) *  p.x + ( num7 -  num12) *  p.y + ( num8 +  num11) *  p.z);
    vector3.y = (( num7 +  num12) *  p.x + (1.0 - ( num4 +  num6)) *  p.y + ( num9 -  num10) *  p.z);
    vector3.z = (( num8 -  num11) *  p.x + ( num9 +  num10) *  p.y + (1.0 - ( num4 +  num5)) *  p.z);
    return vector3;
}
